...
$wallet_url	= trailingslashit( mlm_page_url('panel') ) . 'section/referrals/';
$per		= 20;
...
<h3 class="mlm-box-title sm mb-3 py-2"><?php _e( 'Referral transactions', 'mlm' ); ?></h3>
