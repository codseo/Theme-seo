...
<div class="mlm-widget bg-white p-4 mb-4 clearfix">
	...
	<div class="mlm-product-vendor-widget clearfix">
		...
		<div class="vendor-name text-center mb-3 clearfix">
			<a href="<?php echo esc_url( $author_url ); ?>" class="vcard author d-inline-block text-dark bold-300 <?php if( $verified ) echo 'verified'; ?>" <?php if( $verified ) echo 'data-toggle="tooltip" data-placement="left" title="" data-original-title="'. __( 'Verified user', 'mlm' ) .'"'; ?>><?php echo $user_name; ?></a>
		</div>
		...
		<div class="vendor-link clearfix">
			<a href="<?php echo add_query_arg( 'section', 'posts', $author_url ); ?>/" class="btn btn-light btn-block"><?php _e( 'See all posts', 'mlm' ); ?></a>
		</div>
	</div>
</div>